<template>
  ...
  <div class="grid bg-gray-800 rounded-lg shadow-xl w-11/12 md:w-9/12 lg:w-1/2">
    ...
    <div class="flex justify-center">
      <div class="flex">
        <h1 class="text-white  font-bold md:text-2xl mt-5 text-xl">Verein  Hinzufügen</h1>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1  mx-7">
      ...
      <textarea v-model="data.description" class="py-2  bg-gray-700 px-3 rounded-lg border-2 border-white mt-1 focus:outline-none focus:ring-2 focus:ring-white focus:border-transparent" type="message" placeholder="Text über denn Verein" />
    </div> 
    
    

    <div class="grid grid-cols-1 mt-5 mx-7">
      <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold mb-1">Vereins Logo Hochladen</label>
